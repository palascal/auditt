"""La Centrale mail — AudiTT wrapper around scrapekit (car filters + year)."""
...
from scrapekit.scrapers.lacentrale_mail import LacentraleMailScraper as _KitMailScraper
...
class LacentraleMailScraper(_KitMailScraper):
    def __init__(self, *args, site_key="lacentrale", **kwargs):
